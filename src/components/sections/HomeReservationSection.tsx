...
interface HomeReservationSectionProps {
  content?: {
    heading?: string;
    subheading?: string;
  };
...
export function HomeReservationSection({ content, 'data-section-key': sectionKey, 'data-section-id': sectionId }: HomeReservationSectionProps = {}) {
  ...
  const heading = content?.heading || "Your Table Awaits";
  const subheading = content?.subheading || "Reserve Now";
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              <h4
                data-section-component-key="heading"
                style={{
              ...
              <h2
                ...
                data-section-component-key="subheading"
              >
                {subheading}
              </h2>
            </div>
